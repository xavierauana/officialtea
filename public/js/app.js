...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vuex = __webpack_require__(43);
	Vue.use(Router);
	Vue.use(Resource);
	Vue.use(Vuex);
	...
	var variable = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function install(Vue) {
	    ...
	    Vue.url = __webpack_require__(21);
	    Vue.http = __webpack_require__(27);
	    Vue.resource = __webpack_require__(42);
	    Vue.Promise = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlTemplate = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(20);
	var Promise = __webpack_require__(29);
	var xhrClient = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(20);
	var PromiseObj = window.Promise || __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jsonpClient = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(20);
	var xdrClient = __webpack_require__(41);
...
/***/ function(module, exports) {
	...
	var ADD_PHONE_DIGIT = "ADD_PHONE_DIGIT";
	var REMOVE_PREVIOUS_DIGIT = "REMOVE_PREVIOUS_DIGIT";
	var RESET_PHONE = "RESET_PHONE";
	
	module.exports = {
	    ADD_TO_QUEUE: ADD_TO_QUEUE,
	    RESET_QUEUE: RESET_QUEUE,
	    ADD_PHONE_DIGIT: ADD_PHONE_DIGIT,
	    REMOVE_PREVIOUS_DIGIT: REMOVE_PREVIOUS_DIGIT,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ADD_TO_QUEUE = _require.ADD_TO_QUEUE;
	var RESET_QUEUE = _require.RESET_QUEUE;
	var ADD_PHONE_DIGIT = _require.ADD_PHONE_DIGIT;
	var REMOVE_PREVIOUS_DIGIT = _require.REMOVE_PREVIOUS_DIGIT;
	var RESET_PHONE = _require.RESET_PHONE;
	...
	var mutations = (_mutations = {}, _defineProperty(_mutations, ADD_TO_QUEUE, function (state) {
	    state.queue.push({ phoneNumber: state.phoneNumber });
	}), _defineProperty(_mutations, RESET_QUEUE, function (state) {
	    state.queue = [];
	}), _defineProperty(_mutations, ADD_PHONE_DIGIT, function (state, digit) {
	    state.phoneNumber += digit;
	}), _defineProperty(_mutations, REMOVE_PREVIOUS_DIGIT, function (state) {
	    if (state.phoneNumber.length > 0) state.phoneNumber = state.phoneNumber.substr(0, state.phoneNumber.length - 1);
	}), _defineProperty(_mutations, RESET_PHONE, function (state) {
	    state.phoneNumber = "";
	}), _mutations);
	
	module.exports = { state: state, mutations: mutations };
